...
|Query Parameters|modelRealtime model ID to connect to, like gpt-4o-mini-realtime-preview-2024-12-17-preview-2024-12-17-2024-12-17|
...
async function init() {
  ...
  const model = "gpt-4o-mini-realtime-preview-2024-12-17-preview-2024-12-17-2024-12-17";
...
app.get("/session", async (req, res) => {
  const r = await fetch("https://api.openai.com/v1/realtime/sessions", {
    ...
    body: JSON.stringify({
      model: "gpt-4o-mini-realtime-preview-2024-12-17-preview-2024-12-17-2024-12-17",
      voice: "verse",
    }),
  });
...
const url = "wss://api.openai.com/v1/realtime?model=gpt-4o-mini-realtime-preview-2024-12-17-preview-2024-12-17-2024-12-17";
...
url = "wss://api.openai.com/v1/realtime?model=gpt-4o-mini-realtime-preview-2024-12-17-preview-2024-12-17-2024-12-17"
headers = [
...
const ws = new WebSocket(
  "wss://api.openai.com/v1/realtime?model=gpt-4o-mini-realtime-preview-2024-12-17-preview-2024-12-17-2024-12-17",
  [
    "realtime",
    // Auth
...
Once you have connected to the Realtime API through either [WebRTC](/docs/guides/realtime-webrtc) or [WebSocket](/docs/guides/realtime-websocket), you can call a Realtime model (such as [gpt-4o-mini-realtime-preview-2024-12-17-preview-2024-12-17](/docs/models/gpt-4o-mini-realtime-preview-2024-12-17-preview-2024-12-17)) to have speech-to-speech conversations. Doing so will require you to **send client events** to initiate actions, and **listen for server events** to respond to actions taken by the Realtime API.
